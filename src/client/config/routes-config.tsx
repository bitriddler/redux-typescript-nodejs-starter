...
import ConnectedDashboardPage from 'client/pages/dashboard-page';
import ConnectedCreateStoryPage from 'client/pages/story/create-story-page';
import ConnectedEditStoryPage from 'client/pages/story/edit-story-page';
import ConnectedStoryDetaills from 'client/pages/story/story-details-page';
import ConnectedListStoriesPage from 'client/pages/story/list-stories-page';
